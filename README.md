...
#### SBT 1.x compatible (Latest 3.0.0)
...
libraryDependencies ++= Seq(
  "com.itv"       %% "scalapact-scalatest-suite"   % "3.0.0" % "test",
...
```scala
addSbtPlugin("com.itv" % "sbt-scalapact" % "3.0.0")
```
...
libraryDependencies ++= Seq(
  "com.itv"       %% "scalapact-circe-0-13"   % "3.0.0" % "test",
  "com.itv"       %% "scalapact-http4s-0-21"  % "3.0.0" % "test",
  "com.itv"       %% "scalapact-scalatest"    % "3.0.0" % "test",
  "org.scalatest" %% "scalatest"              % "3.0.5" % "test"
)
```
...
```scala
 libraryDependencies ++= Seq(
   "com.itv" %% "scalapact-argonaut-6-2" % "3.0.0",
   "com.itv" %% "scalapact-http4s-0-21"  % "3.0.0"
 )
 
 addSbtPlugin("com.itv" % "sbt-scalapact-nodeps" % "3.0.0")
```
