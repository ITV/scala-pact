...
#### SBT 1.x compatible (Latest 3.3.2-RC2)
...
libraryDependencies ++= Seq(
  "com.itv"       %% "scalapact-scalatest-suite"   % "3.3.2-RC2" % "test",
...
```scala
addSbtPlugin("com.itv" % "sbt-scalapact" % "3.3.2-RC2")
```
...
libraryDependencies ++= Seq(
  "com.itv"       %% "scalapact-circe-0-13"   % "3.3.2-RC2" % "test",
  "com.itv"       %% "scalapact-http4s-0-21"  % "3.3.2-RC2" % "test",
  "com.itv"       %% "scalapact-scalatest"    % "3.3.2-RC2" % "test",
  "org.scalatest" %% "scalatest"              % "3.0.5" % "test"
)
```
...
```scala
 libraryDependencies ++= Seq(
   "com.itv" %% "scalapact-argonaut-6-2" % "3.3.2-RC2",
   "com.itv" %% "scalapact-http4s-0-21"  % "3.3.2-RC2"
 )
 
 addSbtPlugin("com.itv" % "sbt-scalapact-nodeps" % "3.3.2-RC2")
```
