...
#### SBT 1.x compatible (Latest 2.3.15)
...
libraryDependencies ++= Seq(
  "com.itv"       %% "scalapact-circe-0-9"   % "2.3.15" % "test",
  "com.itv"       %% "scalapact-http4s-0-18" % "2.3.15" % "test",
  "com.itv"       %% "scalapact-scalatest"   % "2.3.15" % "test",
...
```scala
addSbtPlugin("com.itv" % "sbt-scalapact" % "2.3.15")
```
...
```scala
 libraryDependencies ++= Seq(
   "com.itv" %% "scalapact-argonaut-6-2" % "2.3.15",
   "com.itv" %% "scalapact-http4s-0-16a" % "2.3.15"
 )
 
 addSbtPlugin("com.itv" % "sbt-scalapact-nodeps" % "2.3.15")
```
