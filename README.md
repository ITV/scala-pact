...
#### SBT 1.x compatible (Latest 4.1.0)
...
libraryDependencies ++= Seq(
  "com.itv"       %% "scalapact-scalatest-suite"   % "4.1.0" % "test",
...
```scala
addSbtPlugin("com.itv" % "sbt-scalapact" % "4.1.0")
```
...
libraryDependencies ++= Seq(
  "com.itv"       %% "scalapact-circe-0-13"   % "4.1.0" % "test",
  "com.itv"       %% "scalapact-http4s-0-21"  % "4.1.0" % "test",
  "com.itv"       %% "scalapact-scalatest"    % "4.1.0" % "test",
  "org.scalatest" %% "scalatest"              % "3.0.5" % "test"
)
```
...
```scala
 libraryDependencies ++= Seq(
   "com.itv" %% "scalapact-argonaut-6-2" % "4.1.0",
   "com.itv" %% "scalapact-http4s-0-21"  % "4.1.0"
 )
 
 addSbtPlugin("com.itv" % "sbt-scalapact-nodeps" % "4.1.0")
```
