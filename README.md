...
#### SBT 1.x compatible (Latest 2.3.1)
...
libraryDependencies ++= Seq(
  "com.itv"       %% "scalapact-circe-0-9"     % "2.3.1" % "test",
  "com.itv"       %% "scalapact-http4s-0-18"   % "2.3.1" % "test",
  "com.itv"       %% "scalapact-scalatest"     % "2.3.1" % "test",
...
```scala
addSbtPlugin("com.itv" % "sbt-scalapact" % "2.3.1")
```
...
```scala
 libraryDependencies ++= Seq(
   "com.itv" %% "scalapact-argonaut-6-2" % "2.3.1",
   "com.itv" %% "scalapact-http4s-0-16a" % "2.3.1"
 )
 
 addSbtPlugin("com.itv" % "sbt-scalapact-nodeps" % "2.3.1")
```
