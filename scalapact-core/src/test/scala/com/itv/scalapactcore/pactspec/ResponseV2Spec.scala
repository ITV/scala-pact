    ...
    it("should check the response body specs") {
      testResponseSpecs(
        List(
          ...
          fetchResponseSpec("/response/body/array in different order xml.json")(StrictAndNonStrict),
          ...
          fetchResponseSpec("/response/body/unexpected index with not null value.json")(StrictAndNonStrict),
          fetchResponseSpec("/response/body/unexpected index with null value.json")(StrictAndNonStrict),
