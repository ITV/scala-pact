    ...
    it("should check the request body specs") {
      testRequestSpecs(
        List(
          ...
          fetchRequestSpec("/request/body/unexpected index with missing value xml.json")(StrictAndNonStrict),
          fetchRequestSpec("/request/body/unexpected index with non-empty value xml.json")(StrictAndNonStrict),
          ...
          fetchRequestSpec("/request/body/unexpected key with empty value xml.json")(StrictAndNonStrict),
          fetchRequestSpec("/request/body/unexpected key with non-empty value xml.json")(StrictAndNonStrict),
